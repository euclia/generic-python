...
class NeuralNetworkModelHandler(tornado.web.RequestHandler):
    ...
    def post(self):
        ...
        #             preds.append(fPred)
        #         j += 1
        #         # if np.int64 == np.dtype(predictions[j]).type:
        #         #     fPred = {i: int(predictions[j])}
        #         #     preds.append(fPred)
        #         # if np.float64 == np.dtype(predictions[j]).type:
        #         #     fPred = {i: float(predictions[j])}
        #         #     preds.append(fPred)
        #         # if np.str_ == np.dtype(str).type:
        #         #     fPred = {i: predictions[j]}
        #         #     preds.append(fPred)
        #         # j += 1
        # finalAll = {"predictions": preds}
